...
```json
{
  ...
  "confidence": 0.87,
  "origin": "suno",
  "origin_confidence": 0.79,
  "risk_timeline": [0.12, 0.88, 0.91, 0.87],
  "tier_verdicts": {
    "press_safe": "ai",
    "human_safe": "ai",
    "recall": "ai"
...
The result fields match the [polling response](/api-reference/tracks/analyze) exactly. `tier_verdicts` is included by default in webhook payloads.
