...
<CardGroup cols={3}>
  <Card title="Press-Safe" icon="shield-check">
    **~0% false positive rate**
    ...
    Near-zero FPR on human recordings. Fires on `prototype_score >= 0.807`.
...
## Press-safe and `prototype_score`

Press-safe uses a proprietary acoustic analysis that remains stable across compression, mastering, and loudness variation. The underlying score is `prototype_score`. Press-safe fires when `prototype_score >= 0.807`.
